...
- KallSonysOms-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- KallSonysOms-ui: main application module, development time
- KallSonysOms-production: module that produces a production mode WAR for deployment
